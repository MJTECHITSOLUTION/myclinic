                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarOne">
                                ...
                                <ul class="navbar-nav m-auto auth-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="sing-in-btn" href="https://wa.me/212659857238"><i
                                                class='lni lni-whatsapp'></i>06 59 85 72 38</a>
                                    </li>
                ...
                <div class="row" data-aos="zoom-out">
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="footer-link">
                            ...
                            <ul>
                                ...
                                <li><a href="https://tayssir.cloud">TAYSSIR App Store</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="footer-link">
                            ...
                            <ul>
                                <li><a href="https://tayssir.cloud/index.php?rp=/login" target="_blank">Support en
                                        ligne</a></li>
                                <li><a href=""
                                        target="_black">Documentation</a></li>
