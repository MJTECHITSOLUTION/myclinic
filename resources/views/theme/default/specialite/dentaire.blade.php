            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    <div class="header-content text-center">
                        <h3 class="header-title">Dentaire</h3>
                    </div> <!-- header content -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3" data-aos="fade-right" data-aos-duration="2500">
                            <div class="features-content feature-box mt-40 d-sm-flex">
                                <div class="features-icon">
                                    <img src="{{ asset('public/theme/default/assets/images/installation.svg') }}"
                                        alt="icon" width="80px" class="mb-2">
                                </div>
                        ...
                        <div class="col-md-3" data-aos="fade-up" data-aos-duration="2500">
                            <div class="features-content feature-box mt-40 d-sm-flex">
                                <div class="features-icon">
                                    <img src="{{ asset('public/theme/default/assets/images/education.svg') }}"
                                        alt="icon" width="80px" class="mb-2">
                                </div>
                                <div class="features-content media-body">
                        ...
                        <div class="col-md-3" data-aos="fade-up" data-aos-duration="2500">
                            <div class="features-content feature-box mt-40 d-sm-flex">
                                <div class="features-icon">
                                    <img src="{{ asset('public/theme/default/assets/images/phone.svg') }}" alt="icon"
