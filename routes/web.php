...
Route::group(['middleware' => ['install']], function () {
    ...
    Route::post('contact/send_message_demo', 'WebsiteController@send_message_demo')->name('message.demo');

    Route::get('send-info', 'SendInfoController@index')->name('send.info');
    Route::post('contact/send_info_data', 'SendInfoController@send_info_data');

    Route::get('send-info-demo', 'SendInfoController@index2')->name('send.info.demo');
    Route::post('contact/send_info_data_demo', 'SendInfoController@send_info_data_demo');
    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::post('profile/update', 'ProfileController@update')->middleware('demo');
        Route::get('profile/change_password', 'ProfileController@change_password');
        Route::post('profile/update_password', 'ProfileController@update_password')->middleware('demo');
...
Route::group(['prefix' => 'specialite'], function () {
    Route::get('/psychologue', 'PsychologueController@index')->name('psychologue');
    Route::get('/Cardiologie', 'CardiologieController@index')->name('cardiologie');
    Route::get('/gynecologie', 'GynecologieController@index')->name('gynecologie');
    Route::get('/kinesitherapeute', 'KinesitherapeuteController@index')->name('kinesitherapeute');
    Route::get('/entreprise', 'EntrepriseController@index')->name('entreprise');
    Route::get('/neurologue', 'NeurologueController@index')->name('neurologue');
    Route::get('/dermatolgie', 'DermatolgieController@index')->name('dermatolgie');
    Route::get('/ophtalmologue', 'OphtalmologueController@index')->name('ophtalmologue');
    Route::get('/orl', 'OrlController@index')->name('orl');
    Route::get('/pneumologie', 'PneumologieController@index')->name('pneumologie');
    Route::get('/generaliste', 'GeneralisteController@index')->name('generaliste');
    Route::get('/gastrologie', 'GastrologieController@index')->name('gastrologie');
    Route::get('/pediatre', 'PediatreController@index')->name('pediatre');
    Route::get('/dermatologie', 'DermatologieController@index')->name('dermatologie');
    Route::get('/dentaire', 'DentaireController@index')->name('dentaire');
    Route::get('/rhumataulogue', 'RhumataulogueController@index')->name('rhumataulogue');
});
